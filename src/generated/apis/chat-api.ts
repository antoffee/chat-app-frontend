...
import { ApiChatRoomEntityOwnerResponse } from '../models';
...
export const ChatApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        chatControllerGetRoomOwner: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError(
                    'id',
                    'Required parameter id was null or undefined when calling chatControllerGetRoomOwner.',
                );
            }
            const localVarPath = `/chat-api/chat/room/{id}/owner`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const ChatApiFp = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async chatControllerGetRoomOwner(
            id: string,
            options?: AxiosRequestConfig,
        ): Promise<
            (axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ApiChatRoomEntityOwnerResponse>>
        > {
            const localVarAxiosArgs = await ChatApiAxiosParamCreator(configuration).chatControllerGetRoomOwner(
                id,
                options,
            );
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
...
export const ChatApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async chatControllerGetRoomOwner(
            id: string,
            options?: AxiosRequestConfig,
        ): Promise<AxiosResponse<ApiChatRoomEntityOwnerResponse>> {
            return ChatApiFp(configuration)
                .chatControllerGetRoomOwner(id, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
...
export class ChatApi extends BaseAPI {
     ...
     * @memberof ChatApi
     */
    public async chatControllerGetRoomOwner(
        id: string,
        options?: AxiosRequestConfig,
    ): Promise<AxiosResponse<ApiChatRoomEntityOwnerResponse>> {
        return ChatApiFp(this.configuration)
